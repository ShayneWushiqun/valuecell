    ...
    async def send_message(
        ...
        *,
        ...
        return StockAnalysisMessageResult(
            ...
            adaptive_planning_reasoning="最近 feedback 更支持 compare-first 研究路径。",
            ...
            planning_adjustments=["最近 compare 更有帮助，因此本轮优先比较。"],
            process_confidence_hint="历史 feedback 信号较一致，本轮 planning 会吸收这些偏好。",
            execution_plan_summary="先看上下文，再补价格，最后汇总结论。",
            evidence_plan_summary="先看 context 和 compare，再补结构化与价格证据，最后做 validation。",
            executed_steps=[],
            skipped_steps=[],
            failed_steps=[],
            related_task_ids=[],
            ...
            thesis_confidence_hint="当前 thesis 仅适合保守参考。",
            provider_stop_reason="当前未进入 external provider。",
            provider_skipped_reason="当前问题未要求额外 external confirmation。",
