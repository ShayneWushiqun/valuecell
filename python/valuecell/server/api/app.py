...
from .routers.decision_effectiveness import create_decision_effectiveness_router
from .routers.decision_outcome_review import create_decision_outcome_review_router
...
from .routers.risk_sizing import create_risk_sizing_router
...
from .routers.stock_analysis_evidence import create_stock_analysis_evidence_router
from .routers.stock_analysis_compare import create_stock_analysis_compare_router
from .routers.stock_analysis_thread_memory import (
    create_stock_analysis_thread_memory_router,
)
from .routers.stock_analysis_thread_compression import (
    create_stock_analysis_thread_compression_router,
)
from .routers.stock_analysis_research_task import (
...
def _add_routes(app: FastAPI, settings) -> None:
    ...
    app.include_router(create_decision_outcome_review_router(), prefix=API_PREFIX)
    ...
    app.include_router(
        create_stock_analysis_thread_compression_router(), prefix=API_PREFIX
    )
    app.include_router(create_stock_analysis_research_task_router(), prefix=API_PREFIX)
    app.include_router(
        create_stock_analysis_research_feedback_router(), prefix=API_PREFIX
    )
